import { useComposedRefs } from "@/pages/TodoPage/components/organisms/TodoBoard/compose-refs";
      ...
      <KanbanColumnContext.Provider value={columnContext}>
        ...
        >
          <ColumnPrimitive
            ...
            style={composedStyle}
            className={cn(
              "max-w-[348px] w-full flex size-full flex-col gap-2 bg-[#ebebeb7a] p-2.5 aria-disabled:pointer-events-none aria-disabled:opacity-50",
              {
