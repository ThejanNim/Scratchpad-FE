...
import { Comment, CommentCreateForm } from '../Comment/comment';
import { suggestionPlugin } from '../Suggestion/suggestion-kit';
import { commentPlugin } from '../Comment/comment-kit';
...
export const BlockDiscussion: RenderNodeWrapper<AnyPluginConfig> = (props) => {
  ...
  function BlockDiscussionWrapper(wrapperProps: any) {
    return (
      <BlockCommentContent
        blockPath={blockPath}
