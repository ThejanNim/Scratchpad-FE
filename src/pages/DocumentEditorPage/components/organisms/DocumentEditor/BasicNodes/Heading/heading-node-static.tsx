...
const headingVariants = cva('relative mb-1', {
  variants: {
    variant: {
      h1: 'mt-[2rem] pb-1 font-heading text-4xl font-bold',
      h2: 'mt-[1.40rem] pb-px font-heading text-2xl font-semibold tracking-tight',
      h3: 'mt-[1rem] pb-px font-heading text-xl font-semibold tracking-tight',
      h4: 'mt-[0.75rem] font-heading text-lg font-semibold tracking-tight',
      h5: 'mt-[0.75rem] text-lg font-semibold tracking-tight',
      h6: 'mt-[0.75rem] text-base font-semibold tracking-tight',
    },
  },
});
